...
var fnAddMediaToUI = function(media) {
        ...
        $("#container #media_"+media_count).popover({'trigger':'click','title':media.Title,'content':'<div class="synopsis">'+media.Plot+'</div><div class="actors"><strong>Actors:</strong>'+media.Actors+'</div>','html':'true','placement':'right','delay':popover_delay});
